...
export function CalendarPane({
  ...
  // Detect sync completion (or timeout after 10s so it doesn't hang forever)
  useEffect(() => {
  ...
  useEffect(() => {
    if (!syncing) return
    const timeout = setTimeout(() => setSyncing(false), 10000)
          ...
          {!status.connected ? (
            ...
            <div className="flex flex-col items-center gap-4 py-4">
              <p className="text-[13px] text-neutral-500 dark:text-neutral-400 text-center leading-relaxed">
                Google Calendar sync is available during early access. Contact us to activate it for your account.
              </p>
              <a
                href="mailto:coagentaic@gmail.com?subject=Activate%20Google%20Calendar&body=Hi%2C%20I'd%20like%20to%20activate%20Google%20Calendar%20sync%20for%20my%20Co-Agent%20account."
